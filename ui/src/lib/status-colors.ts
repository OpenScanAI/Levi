...
export const statusBadge: Record<string, string> = {
  ...
  // Throttle reasons
  BUDGET_EXCEEDED: "bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300",
  NO_CONTEXT: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300",
};
